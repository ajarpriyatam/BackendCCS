...
exports.registerUser = catchAsyncErrors(async (req, res, next) => {
  ...
  try {
    const welcomeMessage = `
      ...
      You can now start shopping and place orders on our platform.
    ...
    await sendEmail({
      email: email,
      subject: "Welcome to CareerCodeSolution - Account Created Successfully",
